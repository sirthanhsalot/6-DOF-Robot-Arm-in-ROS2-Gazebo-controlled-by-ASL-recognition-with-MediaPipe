...
package_share = get_package_share_directory('cv')
model_path = os.path.join(package_share, 'model/keypoint_classifier/keypoint_classifier.tflite')
label_path = os.path.join(package_share, 'model/keypoint_classifier/keypoint_classifier_label.csv')
